...
[ ! -d "$DATA_OPTIMIZER_CACHE_FOLDER" ] && mkdir -p "$DATA_OPTIMIZER_CACHE_FOLDER"
...
python litgpt/scripts/prepare_finefineweb.py \
    /n/netscratch/doshi-velez_lab/Everyone/ffw_mysubset20BT/mathematics0.05 \
    /n/netscratch/doshi-velez_lab/Everyone/ffw_mysubset20BT/mathematics0.05_litgpt/pretrain/train \
