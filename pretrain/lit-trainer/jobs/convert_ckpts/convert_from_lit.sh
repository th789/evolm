...
#0.5B models
# model_dir=models/pretrained/llama-0.5B-10BT-weightdecay0.0-seed42
...
#1B models
# model_dir=models/pretrained/llama-1B-20BT-weightdecay0.0-seed42
...
#4B models
model_dir=/n/netscratch/doshi-velez_lab/Everyone/models/pretrained/llama-4B-80BT-weightdecay0.0-seed42

#FINEWEB_FOLDER_PATH_PV path is same for all models above, defined in load_private_vars.sh

#need to export this even though not using it here bc of the way litgpt is set up
percent_doi=0.001 
