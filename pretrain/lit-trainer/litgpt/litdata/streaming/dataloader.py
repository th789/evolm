...
from litgpt.litdata.constants import _DEFAULT_CHUNK_BYTES, _VIZ_TRACKER_AVAILABLE
from litgpt.litdata.streaming import Cache
from litgpt.litdata.streaming.combined import (
    __NUM_SAMPLES_YIELDED_KEY__,
    __SAMPLES_KEY__,
    CombinedStreamingDataset,
)
from litgpt.litdata.streaming.dataset import StreamingDataset
from litgpt.litdata.streaming.sampler import CacheBatchSampler
from litgpt.litdata.utilities._pytree import tree_flatten
from litgpt.litdata.utilities.env import _DistributedEnv
...
class WorkerLoop:
    ...
    def __call__(
        ...
        **kwargs: Any,
        ...
        from litgpt.litdata.streaming.cache import Cache
