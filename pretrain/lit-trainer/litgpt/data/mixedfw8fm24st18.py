...
@dataclass
class MixedFW8FM24ST18(DataModule):
    """The MixedFW8FM24ST18 data module is composed of a mix of data.
        ...
        for path in self.required_paths:
            if not path.startswith("s3://") and not Path(path).is_dir():
                raise FileNotFoundError(
                    "The data path for MixedFW8FM24ST18 is expected to be the directory containing these subdirectories:"
    ...
    def train_dataloader(self) -> DataLoader:
        ...
        # Total: 50BT = fineweb: 8BT + finemath: 24BT + stackedu: 18BT
        weights = (8, 24, 18)
