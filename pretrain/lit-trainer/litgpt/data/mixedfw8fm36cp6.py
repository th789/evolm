...
@dataclass
class MixedFW8FM36CP6(DataModule):
    """The MixedFW8FM36CP6 data module is composed of a mix of data.
        ...
        for path in self.required_paths:
            if not path.startswith("s3://") and not Path(path).is_dir():
                raise FileNotFoundError(
                    "The data path for MixedFW8FM36CP6 is expected to be the directory containing these subdirectories:"
    ...
    def train_dataloader(self) -> DataLoader:
        ...
        # Total: 50BT = fineweb: 8BT + finemath: 36BT + codepretrain: 6BT
        weights = (8, 36, 6)
