...
@dataclass
class MixedFW8FM32(DataModule):
    """The MixedFW8FM32 data module is composed of a mix of data.
        ...
        for path in self.required_paths:
            if not path.startswith("s3://") and not Path(path).is_dir():
                raise FileNotFoundError(
                    "The data path for MixedFW8FM32 is expected to be the directory containing these subdirectories:"
    ...
    def train_dataloader(self) -> DataLoader:
        ...
        # Total: 40BT = fineweb: 8BT + finemath: 32BT
        weights = (8, 32)
