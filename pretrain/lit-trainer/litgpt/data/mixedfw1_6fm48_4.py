...
@dataclass
class MixedFW1_6FM48_4(DataModule):
    """The MixedFW1_6FM48_4 data module is composed of a mix of data.
        ...
        for path in self.required_paths:
            if not path.startswith("s3://") and not Path(path).is_dir():
                raise FileNotFoundError(
                    "The data path for MixedFW1_6FM48_4 is expected to be the directory containing these subdirectories:"
    ...
    def train_dataloader(self) -> DataLoader:
        ...
        # Total: 50BT = fineweb: 1.6BT + finemath: 48.4BT
        weights = (1.6, 48.4)
