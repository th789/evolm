...
@dataclass
class MixedFW16FM34(DataModule):
    """The MixedFW16FM34 data module is composed of a mix of data.
        ...
        for path in self.required_paths:
            if not path.startswith("s3://") and not Path(path).is_dir():
                raise FileNotFoundError(
                    "The data path for MixedFW16FM34 is expected to be the directory containing these subdirectories:"
    ...
    def train_dataloader(self) -> DataLoader:
        ...
        # Total: 50BT = fineweb: 16BT + finemath: 34BT
        weights = (16, 34)
