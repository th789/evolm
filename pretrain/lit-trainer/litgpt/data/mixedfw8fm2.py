...
@dataclass
class MixedFW8FM2(DataModule):
    """The MixedFW8FM2 data module is composed of a mix of data.
        ...
        for path in self.required_paths:
            if not path.startswith("s3://") and not Path(path).is_dir():
                raise FileNotFoundError(
                    "The data path for MixedFW8FM2 is expected to be the directory containing these subdirectories:"
    ...
    def train_dataloader(self) -> DataLoader:
        ...
        # Total: 10BT = fineweb: 8BT + finemath: 2BT
        weights = (8, 2)
