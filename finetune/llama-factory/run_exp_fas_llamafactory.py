...
def run_exp01_finetune_llama():
    ...
    for config_file_path in config_file_paths:
        ...
        run_bash_script_simplified(bash_script=bash_script, 
                        ...
                        # n_nodes='1', n_gpus_a100_80gb='4', n_tasks_per_node='4', cpus_per_task='12', time_hrs='7', memory_gb='64',  #llama1B/llama0.5B/olmo: metamathqa
                        ...
                        # n_nodes='1', n_gpus_a100_80gb='4', n_tasks_per_node='4', cpus_per_task='12', time_hrs='4', memory_gb='64',  #olmo: race, simplescaling
                        n_nodes='1', n_gpus_a100_80gb='4', n_tasks_per_node='4', cpus_per_task='12', time_mins='45', memory_gb='64',  #llama1B/llama0.5B/olmo: hellaswag, winogrande, piqa, arc_easy, arc_challenge, safetymixed300, safetymixed500, safetymixed1000, safetymixed2000 -- very quick<20min
                        ###model: 4B llama
                        # n_nodes='1', n_gpus_a100_80gb='4', n_tasks_per_node='4', cpus_per_task='12', time_hrs='20', memory_gb='64', #llama4B: metamathqa
                        # n_nodes='1', n_gpus_a100_80gb='4', n_tasks_per_node='4', cpus_per_task='12', time_hrs='15', memory_gb='64', #llama4B: medmcqa
...
#note
#sbatch: 4 GPUs (1 node): wnen nodes=1, ntasks-per-node must equal n_gpus --> so n_gpus = ntasks-per-node = 4
def run_exp05_finetune_llama_vary_lr_in_pt():
    ...
    for combo in combos:
        ...
        if model_size in ['olmo-1B-30BT']:
            config_file_path = f'config_hub/custom_configs/ft_{sft_dataset}/{model_size}-weightdecay{wd_pt}-lr{lr_pt}-{sft_dataset}.yaml'
            model_path = f'/n/home07/than157/desktop/done-large_projects/learn-better/evolm/finetune/llama-factory/llamafactory_out/{model_size}-weightdecay{wd_pt}-lr{lr_pt}-{sft_dataset}'
