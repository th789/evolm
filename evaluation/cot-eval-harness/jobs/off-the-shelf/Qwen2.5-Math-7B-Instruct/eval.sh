...
model_ckpt_dir=Qwen/Qwen2.5-Math-7B-Instruct
model_id_for_saving=Qwen2.5-Math-7B-Instruct--zeroshot
prompt_config_file=prompts/Qwen2.5-Math-7B-Instruct/default_dataset/prompt_config.json
dataset_name=GSM8K
