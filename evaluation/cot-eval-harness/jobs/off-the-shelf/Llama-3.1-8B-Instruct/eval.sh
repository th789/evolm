...
model_ckpt_dir=meta-llama/Llama-3.1-8B-Instruct
model_id_for_saving=Llama-3.1-8B-Instruct--zeroshot
prompt_config_file=prompts/Llama-3.1-8B-Instruct/default_dataset/prompt_config.json
dataset_name=MMLUProNoMathSTEM
